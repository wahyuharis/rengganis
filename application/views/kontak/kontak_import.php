    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-footer">
                <span style="display: none;" id="prev-btn" class="float-left btn btn-outline-primary btn-lg">PREVIOUS</span>
                <span id="next-btn" class="float-right btn btn-outline-primary btn-lg">NEXT</span>
            </div>
        </div>
    </div>
</div>
